...
function blockDomain(){
	...
	return location.host.indexOf('baidu') < 0 && location.href.indexOf('baidu') > 0;
}

chrome.webRequest.onBeforeRequest.addListener(
	function(details) {
		return {
			cancel: blockWords(details.url) || blockHost(details.url) || blockDomain()
		};
	},
	{
		urls: ["<all_urls>"]
